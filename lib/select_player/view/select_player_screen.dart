...
class SelectPlayerScreen extends GetView<HomeController> {
  ...
  StatelessElement createElement() {
    controller.state.teams = LocalStorage.getData(Constants.TEAMS);
    controller.selectedTeamCode = LocalStorage.getData(Constants.TEAMS)[0]['code'];
  ...
  void addRemoveFunction({required Map<String, dynamic> player}) {
    ...
    log('LisT: ${controller.state.selectedPlayers}');
  }
